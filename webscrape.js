...
let scrape = async () => { // Prepare scrape...
  ...
  await page.goto('https://www.google.com/maps/place/Microsoft/@36.1275216,-115.1728651,17z/data=!3m1!5s0x80c8c416a26be787:0x4392ab27a0ae83e0!4m7!3m6!1s0x80c8c4141f4642c5:0x764c3f951cfc6355!8m2!3d36.1275216!4d-115.1706764!9m1!1b1'); // Define the Maps URL to Scrape...
  // await page.waitFor(1000); // In case Server has JS needed to be loaded...
	...
	const result = await page.evaluate(() => { // Let's create variables and store values...
		...
		let fullName = document.querySelector(".d4r55")?.textContent.trim(); // Full Name
		let postDate = document.querySelector(".rsqaWe")?.textContent.trim(); // Date Posted
		let starRating = parseFloat(document.querySelector(".kvMYJc")?.getAttribute("aria-label")); // Star Rating
		let postReview = document.querySelector(".MyEned")?.textContent.trim(); // Review Posted by Full Name aka Poster
